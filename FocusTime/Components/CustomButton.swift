...
class CustomButton: UIButton {
    ...
    private func setButtonStyle() {
        ...
        self.addTarget(self, action: #selector(CustomButton.changeBackgroundColor), for: [.touchDown])
        self.addTarget(self, action: #selector(CustomButton.resetBackgroundColor), for: [.touchDragExit, .touchCancel, .touchUpInside, .touchUpOutside])
    }
